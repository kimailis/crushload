  ...
  return (
    <div className="min-h-[100dvh] bg-[#030712] text-zinc-300 font-sans selection:bg-blue-500/30 overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col h-[100dvh]">
        <header className="h-[72px] bg-[#0a0f1c]/80 backdrop-blur-3xl flex items-center justify-between px-4 lg:px-6 shrink-0 z-50 sticky top-0 shadow-sm border-b border-white/5" id="cyber-header">
